...
def inference(model):
    ...
    image_count = image_count = dataframe.shape[0]
    ...
    with open(output_directory + "tf_inference_times.csv", 'w', newline='') as file:
        writer = csv.writer(file, delimiter=',')
        writer.writerow(['Filename', 'Preprocessing time (ms)', 'Inference time (ms)','y_pred'])
        for i in range(image_count):
            ...
            writer.writerow([filenames[i], preprocessing_times[i] * 1000, inference_times[i] * 1000,y_pred])
